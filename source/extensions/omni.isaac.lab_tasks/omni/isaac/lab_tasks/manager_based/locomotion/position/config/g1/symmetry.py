...
def _switch_arms_legs_lr(dof):
    ...
    dof_switched[..., 9] = dof[..., 10] * -1  # left_shoulder_roll_joint <-> right_shoulder_roll_joint (roll -> reverse sign)
    dof_switched[..., 10] = dof[..., 9] * -1
    
    dof_switched[..., 13] = dof[..., 14] * -1  # left_shoulder_yaw_joint <-> right_shoulder_yaw_joint (yaw -> reverse sign)
